...
down_revision: Union[str, Sequence[str], None] = 'eef03f799c01'
...
def upgrade() -> None:
    ...
    op.add_column('leads', sa.Column('stripe_checkout_session_id', sa.String(length=255), nullable=True))
    op.add_column('leads', sa.Column('stripe_payment_intent_id', sa.String(length=255), nullable=True))
    ...
    op.add_column('leads', sa.Column('booking_link_sent_at', sa.DateTime(timezone=True), nullable=True))
    ...
    op.add_column('leads', sa.Column('last_client_message_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('leads', sa.Column('last_bot_message_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('leads', sa.Column('reminder_qualifying_sent_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('leads', sa.Column('reminder_booking_sent_24h_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('leads', sa.Column('reminder_booking_sent_72h_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('leads', sa.Column('stale_marked_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('leads', sa.Column('abandoned_marked_at', sa.DateTime(timezone=True), nullable=True))
    ...
    op.add_column('leads', sa.Column('last_admin_action_at', sa.DateTime(timezone=True), nullable=True))
    ...
    op.create_index(op.f('ix_processed_messages_lead_id'), 'processed_messages', ['lead_id'], unique=False)
