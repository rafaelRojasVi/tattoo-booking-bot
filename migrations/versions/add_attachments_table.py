...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_attachments_lead_answer_id"), "attachments", ["lead_answer_id"], unique=False)
    op.create_index(op.f("ix_attachments_whatsapp_media_id"), "attachments", ["whatsapp_media_id"], unique=False)
    op.create_index(op.f("ix_attachments_object_key"), "attachments", ["object_key"], unique=False)
    op.create_index(op.f("ix_attachments_upload_status"), "attachments", ["upload_status"], unique=False)
...
def downgrade() -> None:
    op.drop_constraint(op.f("fk_attachments_lead_answer_id_lead_answers"), "attachments", type_="foreignkey")
