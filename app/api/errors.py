...
def status_mismatch_detail_admin(action_phrase: str, lead_status: str, expected_status: str) -> str:
    """
    ...
    """
    return f"Cannot {action_phrase} in status '{lead_status}'. Lead must be in '{expected_status}'."
